...
namespace constants_sql {
    ...
    // Work Record 相关SQL
    // =====================
    constexpr const char* SQL_INSERT_WORK_RECORD = "INSERT INTO work_record (requirement_id, work_type_id, affected_id, source_type_id, work_record_status_id, work_content, employee_id) VALUES (?, ?, ?, ?, ?, ?, ?);";
